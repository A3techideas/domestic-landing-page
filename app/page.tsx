        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            >
              ...
              <span className="whitespace-nowrap">+919821130907</span>
            </a>
            <a
              href="https://wa.me/+919821130907"
              target="_blank"
      ...
      <footer className="bg-[#F56F19] px-4 sm:px-8 py-8 sm:py-12 lg:px-16 overflow-x-hidden w-full max-w-full">
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-center gap-4 sm:gap-6 mb-6 sm:mb-8">
            <a
              href="https://www.instagram.com/a3ideanix/?hl=en"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.linkedin.com/company/a3-ideanix-technology-pvt-ltd/?viewAsMember=true"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white hover:text-gray-200 transition-colors"
          ...
          <p className="text-white text-center text-sm sm:text-base"> Ground Floor, 25B, Institutional Area, Sector 32, Gurugram, Haryana 122001</p>
        </div>
      </footer>
    </div>
  );
